    ...
    public static class JSMSeries extends JSMBaseObject implements Series {
        ...
        public static class JSMStates extends JSMBaseObject implements States {
            ...
            public JSMHover getHover() {
                if (this.hover == null)
                    this.hover = new JSMHover();
                return hover;
            }

            @XmlElement(type = JSMHover.class)
            ...
            public static class JSMHover extends JSMBaseObject implements Hover {
                @Override
                public JSMHover setEnabled(boolean enabled) {
                ...
                @Override
                public JSMHover setLineWidth(int lineWidth) {
                    this.lineWidth = lineWidth;
                    return this;
                }
                ...
                @Override
                public JSMHover setBrightness(double brightness) {
